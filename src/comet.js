...
module.exports.Comet = function(comet) {
  ...
  var GetPos = function(julian) {
    ...
    var mtxPrec = Matrix.PrecMatrix(this.equinoxTime.getJd(), Astro.JD2000);
    return xyz.Rotate(mtxPrec);
  };

  var getEquinoxJd = function() {
